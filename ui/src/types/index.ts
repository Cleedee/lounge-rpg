...
export const CLASS_META: Record<CharacterClass, {
  ...
  TabbyWarrior: {
    emoji: "⚔️",
    label: "Tabby Warrior",
    labelKey: "TabbyWarrior",
    description: "A street brawler with reinforced claws and unmatched resilience.",
    descriptionKey: "TabbyWarrior.desc",
    ability: "Nine Lives Surge",
    abilityKey: "TabbyWarrior.ability",
    stats: { str: 8, agi: 5, arc: 2, stl: 4 },
  },
  SiameseMage: {
    emoji: "🔮",
    label: "Siamese Mage",
    labelKey: "SiameseMage",
    description: "A silk-voiced arcanist who bends neon light into arcane force.",
    descriptionKey: "SiameseMage.desc",
    ability: "Ley Line Pulse",
    abilityKey: "SiameseMage.ability",
    stats: { str: 3, agi: 6, arc: 9, stl: 5 },
  },
  MaineCoonPaladin: {
    emoji: "🛡️",
    label: "Maine Coon Paladin",
    labelKey: "MaineCoonPaladin",
    description: "An armoured crusader with a Holy Hairball Shield and iron will.",
    descriptionKey: "MaineCoonPaladin.desc",
    ability: "Sacred Barrier",
    abilityKey: "MaineCoonPaladin.ability",
    stats: { str: 6, agi: 3, arc: 5, stl: 2 },
  },
  SphinxRogue: {
    emoji: "🌙",
    label: "Sphinx Rogue",
    labelKey: "SphinxRogue",
    description: "A shadow operative. No records. No remorse. High agility and stealth.",
    descriptionKey: "SphinxRogue.desc",
    ability: "Vanish Protocol",
    abilityKey: "SphinxRogue.ability",
    stats: { str: 4, agi: 9, arc: 4, stl: 9 },
  },
};

export const WORKFLOW_STEPS_DEFAULT: WorkflowStep[] = [
  { name: "RetrieveLore", label: "RetrieveLore", service: "App", status: "pending" },
  { name: "InvokeDungeonMaster", label: "InvokeDungeonMaster", service: "Ollama", status: "pending" },
  { name: "PersistCampaign", label: "PersistCampaign", service: "SQLite", status: "pending" },
  { name: "FormatResponse", label: "FormatResponse", service: "App", status: "pending" },
];
...
export const PLACEHOLDER_KEYS = [
  "action_input.placeholder.search",
  "action_input.placeholder.attack",
  "action_input.placeholder.distract",
  "action_input.placeholder.sneak",
  "action_input.placeholder.haggle",
  "action_input.placeholder.hack",
];
