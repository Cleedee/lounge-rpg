...
import { PLACEHOLDER_ACTIONS, PLACEHOLDER_KEYS } from "../../types";
import { t } from "../../i18n";
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder={
          state.isProcessing
            ? t("action_input.processing", "Processing turn...")
            : !state.campaignId
            ? t("action_input.no_campaign", "Start a new game above to play ↑")
            : t(PLACEHOLDER_KEYS[placeholderIdx], PLACEHOLDER_ACTIONS[placeholderIdx])
        }
